...
namespace AA
{
	...
	public:
		...
		int getY(){ return y; }  //var to get the y value since its private
		...
		void updatePlatformsPosition(SDL_Renderer* renderer, SDL_Rect* rect1, SDL_Rect* rect2, SDL_Rect* ball, bool gameStarted, int* computerSpeed);  //method that is used to update the values of x and y of the platforms
