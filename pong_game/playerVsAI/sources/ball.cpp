...
namespace AA
{
	...
	bool Ball::updateBallPosition(SDL_Renderer* renderer, SDL_Rect* ball, bool ballLaunched, SDL_Rect* plat1, SDL_Rect* plat2, int* p1Score, int* p2Score, int* computerSpeed)  //a method to update the ball position the the screen
	{
